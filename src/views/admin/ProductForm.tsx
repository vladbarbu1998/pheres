...
export default function ProductForm() {
  ...
  const urlProductType = (searchParams?.get("type") ?? null) as "couture" | "ready_to_wear" | null;
  ...
  const onSubmit = async (data: ProductFormData) => {
    ...
    try {
      ...
      const finalProductId: string = productId;
      ...
      router.push(`/admin/products?type=${productType}`);
    } catch (error: any) {
      console.error(error);
